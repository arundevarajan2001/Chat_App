    ...
    return(
        ...
        <div className="login">
            <form>
                ...
                <div className="mb-3 mt-3 Fields">
                ...
                <div className="form-check mb-3 other-fields">
                    <label className="form-check-label">
                    <h6> <input className="form-check-input" type="checkbox" name="remember" onClick={(e)=>setRememberme(!Rememberme)} /> Remember me </h6>
                    </label>
                </div>
                <button type="button" className="btn btn-primary other-fields" onClick={on_sub}>Sign up</button>
            </form>
        </div>
        </div>
        </>
